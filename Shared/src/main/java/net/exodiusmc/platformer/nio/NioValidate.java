...
import net.exodiusmc.platformer.nio.exception.NioValidationException;
...
public class NioValidate {
     ...
     *
     * @param check Validation check
     * @throws net.exodiusmc.platformer.nio.exception.NioValidationException when check is null
     */
